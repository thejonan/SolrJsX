...
describe("SolrJsX adapters", function () {
  ...
  describe("Raw Solr Translation", function (){
    var topic = new (a$(Solr.RawAdapter))(),
        data = topic.parseResponse(TestData.RawSolr);
  ...
  describe("Nested Solr Translation", function (){
    var topic = new (a$(Solr.NestedAdapter))(),
        data = topic.parseResponse(Solr.QueryingJson.prototype.parseResponse(TestData.NestedSolr));
