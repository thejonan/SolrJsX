...
(function(global, factory) {
    ...
    global["solr-jsx"] = factory(global.a$, global._));
    ...
    Texting.prototype = {
        ...
        addValue: function(q) {
            var val = this.escapeNeedle && q ? q.replace(/\s+/g, "\\ ") : q, before = this.manager.getParameter("q"), res = this.manager.addParameter("q", val, this.domain);
